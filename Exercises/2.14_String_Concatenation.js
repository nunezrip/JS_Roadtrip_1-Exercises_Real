...
// Use the same twenty20 variable, but change your variable’s contents
...
const twenty20 = `Never look back.`[0] + `Adventure is out there.`[3] + `Just keep swimming.`[14] + `To infinity... and beyond!`[1]
